...
websocket_urlpatterns = [
    path('ws/chat/<str:transaction_id>/', consumers.ChatConsumer.as_asgi()),
]
...
urlpatterns = [
    ...
    path('api/chat/<uuid:transaction_id>/', MessageViewSet.as_view({'get':'conversation'}), name='conversation'),
    path('api/chat/<uuid:transaction_id>/', MessageViewSet.as_view({'post': 'conversation'}), name='conversation'),
