...
class BookViewSet(viewsets.ModelViewSet):
    ...
    def partial_update(self, request, *args, **kwargs):
        ...
        # Handle file upload
        cover_image = request.FILES.get('cover_image') if 'cover_image' in request.FILES else book.cover_image
        ...
        book.course = course
        book.price = price
        book.exchange_option = exchange_option
        book.quantity = quantity
        print(book.title, book.isbn, book.course, book.price, book.exchange_option)
        if cover_image:
            book.cover_image = cover_image

        # Save to trigger status recalculation
        book.save()
